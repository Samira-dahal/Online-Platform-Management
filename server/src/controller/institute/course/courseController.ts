...
const createCourse = async (req:IExtendedRequest, res:Response) => {
   ...
   if(!coursePrice || !courseName || !courseDescription || !courseDuration || !courseLevel){
    ...
    const returnedData = await sequelize.query(`INSERT INTO course_${instituteNumber}(courseName, courseDescription, coursePrice, courseDuration, courseLevel, courseThumbnail) VALUES(?,?,?,?,?,?)`, {
